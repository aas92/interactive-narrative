...
(function () {
    ...
    function conditions(p, m, prog) {
        ...
        var FILL_FRAMES = 330;                          // ~5.5s — paced to the slow leaf fall
        ...
        for (var i = 0; i < d.length; i++) {
            ...
            // settled autumn-leaf texture riding on top of it
    ...
    function leafFill_settledTexture(p, sys, row, x0, y, w, barH) {
        ...
        for (var k = 0; k < n; k++) {
            ...
            p.push(); p.translate(lx, ly); p.rotate(s * 6.28);
